...
export function KanbanBoardClient({ pendencias, onUpdatePendencia, onEditPendencia }: KanbanBoardProps) {
  ...
  if (!mounted) {
    ...
    return (
      <div className="flex gap-6 h-full overflow-x-auto pb-6">
        {columns.map((column) => (
          <div key={column.id} className="w-80 flex-shrink-0 bg-gray-50 rounded-lg p-4 animate-pulse">
